...
<div class="span10 content">    
    ...
    <div class="span11">
            <div class="alert alert-info">
                <strong>Upload DISTRICENTER Client File to Generate Writer File</strong>
            </div>
        <form method="POST" class="form-horizontal" action="output_file_xlsx.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            <div class="control-group">
                <label class="control-label" for="excel_file">XLSX / XLS : </label>
                <div class="controls">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File successfully generated! <a href="<?php echo "./"."writer-files"."/".$_REQUEST['file']; ?>">Click here to download</a><strong>
                </div>
            <?  
            }   
...
function checkfile()
{
    ...
    {
        msg=msg+"please upload (xlsx) file.. \n";
        error=error+1;
    }
    if(error>0) 
    {
