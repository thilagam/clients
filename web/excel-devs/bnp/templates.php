...
<div class="span10 content">    
    <h2 class="heading">BNP xlsx to multiDocx</h2>        
    <div class="span11">
            <div class="alert alert-info">
                <strong>Generate writers file .xlsx > . docx (URL)</strong>
            </div>
        <form method="POST" class="form-horizontal" action="template_process.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            <div class="control-group">
                <label class="control-label">BNP XLSX : </label>
                <div class="controls">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File successfully generated! <a href="template_process.php?action=download&file=<?=$_REQUEST['file']?>&folder=<?=$_REQUEST['folder']?>">Click here to download</a><strong>
                </div>
            <?  
            }   
...
function checkfile()
{
    ...
    var msg='';
     if((document.importexcel.userfile1.value.match('.+\.xlsx')))
        ...
        {
            msg=msg+"please select the excel file (xlsx) \n";
            error=error+1;
        }
