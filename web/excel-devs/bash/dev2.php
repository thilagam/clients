...
<div class="span10 content">    
    <h2 class="heading">BA&SH multiXLSX to xlsx</h2>        
    <div class="span11">
            <div class="alert alert-info">
                <strong>Delivery file .zip (.xlsx)  > .xlsx</strong>
            </div>
        <form method="POST" class="form-horizontal" action="dev2_writer.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            <div class="control-group">
                <label class="control-label">BA&SH .Zip (.xslx) : </label>
                <div class="controls">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File successfully generated! <a href="dev2_writer.php?action=download&file=<?=$_REQUEST['file']?>">Click here to download</a><strong>
                </div>
            <?  
            }   
