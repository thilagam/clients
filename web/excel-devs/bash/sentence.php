...
<div class="span10 content">    
    <h2 class="heading">BASH xls dev - Add sentence</h2>        
    <div class="span11">
            <div class="alert alert-info">
                <strong>Upload bash source file to generate Writer file</strong>
            </div>
        <form method="POST" class="form-horizontal" action="sentence_write_xls.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <?php for ($i = 'A', $j = 1; $j <= 26; $i++, $j++) { ?><option value="<?php echo $j;?>" <?php if($j==13) echo "selected"; ?>><?php echo $i;?></option>
                    <?php  }        ?>
            ...
            <div class="control-group">
                <label class="control-label">Language option : </label>
                <div class="controls">
                    <input type="radio" name="langtext" id="langtext" value="fr" checked /> French <input type="radio" name="langtext" id="langtext" value="en" /> English
                </div>
            </div>
            <div class="control-group">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File successfully generated! <a href="sentence_write_xls.php?action=download&file=<?=$_REQUEST['file']?>&ref=<?=$_REQUEST['ref']?>">Click here to download</a><strong>
                </div>
            <?  
            }   
...
<style>#langtext{margin-bottom:8px;}</style>
