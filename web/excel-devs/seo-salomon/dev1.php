...
<div class="span10 content">    
    <h2 class="heading">SEO SALOMON xlsx</h2>        
    <div class="span11">
            <div class="alert alert-info">
                <strong>CREATION Delivery file .xlsx</strong>
            </div>
        <form method="POST" class="form-horizontal" action="dev1_write.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            <div class="control-group">
                <label class="control-label">English (.xlsx) : </label>
                <div class="controls">
                    <input type="file" id="userfile2" name="userfile2">                   
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">Other Language (.xlsx) : </label>
                <div class="controls">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select name='language' id='language' class="span3">
						...
						<option value="ES-Spanisch">Spanisch</option>
						<option value="IT-Italic">Italic</option>
            ...
            ?>
                ...
                <?php  if(!empty($_SESSION['words_translated']) || !empty($_SESSION['words_not_translated'])){ ?>
                <div><h4>Total Unique Words</h4><?php echo "Words Translated       =   ".$_SESSION['words_translated']; echo "<br />"; echo "Words Not Translated =   ".$_SESSION['words_not_translated']; ?></div><?php } ?>
            <?  
            }   
...
function checkfile()
{
    var error=0;
    var msg='';
     if((document.importexcel.userfile2.value.match('.+\.xlsx')))
        {
            error=error;
        }
        else
     ...
     if(document.getElementById("language").value == "")
        {
            msg=msg+"please select language \n";
            error=error+1;
        }
        else
        {
