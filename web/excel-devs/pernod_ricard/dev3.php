...
<div class="span10 content">    
    <h2 class="heading">PERNOD RICARD - KEYWORDS to TRANSLATION</h2>
    <div class="span11">
            <div class="alert alert-info">
                <strong>Delivery Dev</strong>
            </div>
        <form method="POST" class="form-horizontal" action="process3.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File long successfully generated! <a href="process3.php?action=download&file=<?=$_REQUEST['file1']?>"  target='_blank'>Click here to download long file</a><strong>
                </div>
