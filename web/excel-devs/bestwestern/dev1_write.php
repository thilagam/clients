...
include_once(BESTWESTERN_PATH."/bestwestern.php");
...
if(isset($_GET['action']) && $_GET['action']=='download' && isset($_GET['file']))
	if(pathinfo($_GET['file'], PATHINFO_EXTENSION)=='zip'){
		odownloadZIP($_GET['file'], BESTWESTERN_WRITER_FILE_PATH."/dev1/", "dev1.php") ;
	}else
		odownloadXLS($_GET['file'], BESTWESTERN_WRITER_FILE_PATH."/dev1/".$_GET['folder']."/", "dev1.php") ;
...
if(isset($_POST['submit']))
{
    ...
    if(($ext == 'xlsx') || ($ext == 'xls'))
    {
        ...
        if(sizeof($final_array)>0)    
        {
          	...
          	$rand="BestWestern-".$lang."-".uniqid()."-".date('d-m-y-h-m');
    	    $srcPath=BESTWESTERN_WRITER_FILE_PATH."/dev1/".$rand."/";
			$srcFile=BESTWESTERN_WRITER_FILE_PATH."/dev1/".$rand."/".$rand.".xlsx";
//			$srcFileZip=HOTELS_WRITER_FILE_PATH2."/dev1/".$rand.".zip";
    	   ...
    	   foreach($final_array as $key=>$arr){
			  ...
			  if($key == 1){
				 ...
				 //  print_r($header_2);exit;
				  ...
				  $data[1]=$bestwestern->nextArticleId();
				  ...
				  $final_array[$key][0] = "http://clients.edit-place.com/excel-devs/bestwestern/refdocs.php?client=BESTWESTERN&folder=".$rand."&file=".$docxfile;
				  $bestwestern->createArticle($data,$arr,$docxfile);
			  }
			  $l++;
		   }
   ...
   */
   ...
   function columns_included_for_docx($array_data,$hd,$titles,$lang){
	   ...
	   $array_data1[4]= $array_data[5];
	   $array_data1[5]= $array_data[2];
	   $array_data1[6]= $array_data[7];
	   $array_data1[7]= $array_data[8];
	   $array_data1[8]= $array_data[9];
	   $array_data1[9]= $array_data[14];
	   $array_data1[10]= $array_data[11];
	   $array_data1[11]= '';
	   $array_data1[12]= $array_data[12];
	   $array_data1[13]= '';
	   $array_data1[14]= $array_data[13];
	   $array_data1[15]= '';
	  
	   if($hd == 1) { $array_data1[1]=0; } else if($hd == 2) { $array_data1[1]="Article ID"; } else { $array_data1[1]=""; }   
	   
	   if($hd == 1) { $array_data1[11]=10; } else if($hd == 2) { $array_data1[11]=$array_data[17]." 1"; } else { $array_data1[11]=""; }
	   
	   if($hd == 1) { $array_data1[13]=12; } else if($hd == 2) { $array_data1[13]=$array_data[17]." 2"; } else { $array_data1[13]=""; }
	    
	   if($hd == 1) { $array_data1[15]=14; } else if($hd == 2) { $array_data1[15]=$array_data[17]." 3"; } else { $array_data1[15]=""; }
   ...
   */
   ...
   function columns_color_included_for_docx($array_data){
	   ...
	   $array_data1=array();
	   $array_data1[1]= $array_data[4];
	   $array_data1[2]= $array_data[4];
	   $array_data1[3]= $array_data[2];
	   $array_data1[4]= $array_data[6];
	   $array_data1[5]= $array_data[3];
	   $array_data1[6]= $array_data[8];
	   $array_data1[7]= $array_data[9];
	   $array_data1[8]= $array_data[10];
	   $array_data1[9]= $array_data[15];
	   $array_data1[10]= $array_data[12];
	   $array_data1[11]= $array_data[17];
	   $array_data1[12]= $array_data[13];
	   $array_data1[13]= $array_data[17];
	   $array_data1[14]= $array_data[14];
	   $array_data1[15]= $array_data[17];
   ...
   */
	 ...
	 // echo "Debug 3<pre>"; print_r ($data); echo "</pre>"; 	exit;	
      ...
      $file_name_docx = $data[1]." ".$data[2]." ".$data[3];
