...
include_once(VOYAGES_PATH."/voyages.php");
...
if(isset($_GET['action']) && $_GET['action']=='download' && isset($_GET['file']))
	if(pathinfo($_GET['file'], PATHINFO_EXTENSION)=='zip'){
		odownloadZIP($_GET['file'], VOYAGES_WRITER_FILE_PATH."/dev1/", "dev1.php") ;
	}else
		odownloadXLS($_GET['file'], VOYAGES_WRITER_FILE_PATH."/dev1/".$_GET['folder']."/", "dev1.php") ;
...
if(isset($_POST['submit']))
{
    ...
    if(($ext == 'xlsx') || ($ext == 'xls'))
    {
        ...
        if(sizeof($final_array)>0)    
        {
          	...
          	$rand="voyagesSNCF-".$lang."-".uniqid()."-".date('d-m-y-h-m');
    	    $srcPath=VOYAGES_WRITER_FILE_PATH."/dev1/".$rand."/";
			$srcFile=VOYAGES_WRITER_FILE_PATH."/dev1/".$rand."/".$rand.".xlsx";
