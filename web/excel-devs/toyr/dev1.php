<?php
/**
 * Toyr's Run: xlsx to multiple docs
 *
 * PHP version 5
 * 
 * @package    ClientDevs
 * @author     Thilagam (developed in Notice Period)
 * @copyright  Edit-Place
 * @version    1.0
 * @since      1.0 August 16 2016
 */
        ...
        <form method="POST" class="form-horizontal" action="dev1_process.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File successfully generated! <a href="dev1_process.php?action=download&file=<?=$_REQUEST['file']?>&folder=<?=$_REQUEST['folder']?>">Click here to download</a><strong>
                </div>
            <?  
            }   
