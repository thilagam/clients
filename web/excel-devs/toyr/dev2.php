...
<div class="span10 content">    
    <h2 class="heading">Toyr's multiDocx to xlsx</h2>        
    <div class="span11">
            <div class="alert alert-info">
                <strong>Toyr's Delivery file .zip (.docx)  > .xlsx</strong>
            </div>
        <form method="POST" class="form-horizontal" action="dev2_process.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            <div class="control-group">
                <label class="control-label">Toyr's .Zip (.docx) : </label>
                <div class="controls">
