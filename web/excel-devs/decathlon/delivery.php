...
<div class="span10 content">    
    <h2 class="heading">DECATHLON  xlsx to Text Zip</h2>        
    <div class="span11">
            <div class="alert alert-info">
                <strong>Generate writers file .xlsx > . docx (URL)</strong>
            </div>
        <form method="POST" class="form-horizontal" action="process_delivery.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            <div class="control-group">
                <label class="control-label">DECATHLON  XLSX : </label>
                <div class="controls">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File successfully generated! <a href="process_delivery.php?action=download&file=<?=$_REQUEST['file']?>&folder=<?=$_REQUEST['folder']?>">Click here to download</a><strong>
                </div>
            <?  
            }   
