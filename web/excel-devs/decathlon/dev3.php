...
<div class="span10 content">				
	<h2 class="heading">Decathlon ZIP(DOCX) Generation</h2>  	
	
	<div class="span11">
		<form class="form-horizontal" name="uploadexcel" action="dev3_writer.php" method="POST" enctype="multipart/form-data" onsubmit="return checkfile();">
			<div class="control-group <?if($err_file)echo "error" ?>">
				<label class="control-label" for="excel_file">Upload Edited Excel File</label>
				<div class="controls">
					<input type="file" id="excel_file" name="userfile1">
		...
		<?php
			...
			?>
				<div class="alert alert-success">
					<strong>Zip(DOCX) successfully created! <a href="dev3_writer.php?action=download&t=<?php echo $_REQUEST['t']; ?>">Click here to download</a><strong>
				</div>
			<?php	//zip_creation(DECATHLON_XML_FILE_PATH3."/",$_REQUEST['t'],1);
