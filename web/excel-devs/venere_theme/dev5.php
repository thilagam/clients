...
<div class="span10 content">    
    <h2 class="heading">Venere Custom Template multiDocx to xlsx</h2>        
    <div class="span11">
            <div class="alert alert-info">
                <strong>Custom Template Delivery file .zip (.docx)  > .xlsx</strong>
            </div>
        <form method="POST" class="form-horizontal" action="dev5_write.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File successfully generated! <a href="dev5_write.php?action=download&file=<?=$_REQUEST['file']?>&folder=<?=$_REQUEST['folder']?>">Click here to download</a><strong>
                </div>
            <?  
            }   
