...
<div class="span10 content">    
    <h2 class="heading">Venere Custom Template xlsx to multiDocx</h2>        
    <div class="span11">
            <div class="alert alert-info">
                <strong>Custom Template Generation .xlsx > . docx (URL)</strong>
            </div>
        <form method="POST" class="form-horizontal" action="dev4_write.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            <div class="control-group">
                <label class="control-label">Venere XLS / XLSX : </label>
                <div class="controls">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File successfully generated! <a href="dev4_write.php?action=download&file=<?=$_REQUEST['file']?>&folder=<?=$_REQUEST['folder']?>">Click here to download</a><strong>
                </div>
            <?  
            }   
