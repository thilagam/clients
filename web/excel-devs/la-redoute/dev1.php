...
<div class="span10 content">    
    <h2 class="heading">La Redoute multiDocx to xlsx</h2>        
    <div class="span11">
            <div class="alert alert-info">
                <strong>Delivery file .rar/.zip (.docx)  > .xlsx</strong>
            </div>
        <form method="POST" class="form-horizontal" action="dev1_write.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            <div class="control-group">
                <label class="control-label">La Redoute .RAR / .ZIP (.docx) : </label>
                <div class="controls">
            ...
            <div class="control-group">    
                <label class="control-label">La Redoute .XSLX : </label>
                <div class="controls">
