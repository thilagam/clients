...
<div class="span10 content">    
    <h2 class="heading">Garnier Dev1</h2>
    <div class="span11">
            <div class="alert alert-info">
                <strong>Upload Garnier source file to generate xlsx</strong>
            </div>
        <form method="POST" class="form-horizontal" action="dev1_upload.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Templates successfully generated! <a href="dev1_upload.php?action=download&file=<?=$_REQUEST['file']?>&ref=<?=$_REQUEST['ref']?>">Click here to download</a><strong>
                </div>
            <?  
            }   
