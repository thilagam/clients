...
<div class="span10 content">    
    <h2 class="heading">Garnier Delivery Creation</h2>
    <div class="span11">
            <div class="alert alert-info">
                <strong>Insert keywords and Translations </strong>
            </div>
        <form method="POST" class="form-horizontal" action="dev4_writer.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File successfully generated! <a href="dev4_writer.php?action=download&file=<?=$_REQUEST['file']?>">Click here to download</a><strong>
                </div>
