...
<div class="span10 content">    
    <h2 class="heading">Garnier Writer templates</h2>
    <div class="span11">
            <div class="alert alert-info">
                <strong>Upload Source file to Insert keywords for translations (Read only 20 Columns from input file)</strong>
            </div>
        <form method="POST" class="form-horizontal" action="dev5_writer.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File Successfully generated! <a href="dev5_writer.php?action=download&f=<?=$_REQUEST['f']?>&bool=zip"  target='_blank'>Click here to download Zip</a><strong><br />
					<strong>Writer File Successfully generated! <a href="dev5_writer.php?action=download&f=<?=$_REQUEST['f']?>&bool=xlsx"  target='_blank'>Click here to download XSLX</a><strong>	
                </div>
