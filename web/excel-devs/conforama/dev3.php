...
<div class="span10 content">    
    <h2 class="heading">Conforama Template multiDocx to xlsx</h2>        
    <div class="span11">
            <div class="alert alert-info">
                <strong>Conforama Delivery file .zip (.docx)  > .xlsx</strong>
            </div>
        <form method="POST" class="form-horizontal" action="dev3_write.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            <div class="control-group">
                <label class="control-label">Conforama .Zip (.docx) : </label>
                <div class="controls">
