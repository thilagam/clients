...
<div class="span10 content">    
    <h2 class="heading">Conforma xlsx to xlsx</h2>        
    <div class="span11">
            <div class="alert alert-info">
                <strong>Conforma xlsx  > xlsx(.docx)</strong>
            </div>
        <form method="POST" class="form-horizontal" action="dev2_write.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            
            <div class="control-group">    
                <label class="control-label">Conforma .XSLX to xlsx(.docx) </label>
                <div class="controls">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File successfully generated! <a href="dev2_write.php?action=download&file=<?=$_REQUEST['file']?>&folder=<?=$_REQUEST['folder']?>">Click here to download</a><strong>
                </div>
            <?  
            }   
...
function checkfile()
{
    var error=0;
    var msg='';
     if(((document.importexcel.userfile1.value.match('.+\.zip')) || (document.importexcel.userfile1.value.match('.+\.rar'))) && (document.importexcel.userfile2.value.match('.+\.xlsx')))
        {
            error=error;
        }
        else
        {
            msg=msg+"please select the file 1 (.zip/.rar) & file 2 (.xslx) \n";
            error=error+1;
        }
