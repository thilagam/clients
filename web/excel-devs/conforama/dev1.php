...
<div class="span10 content">    
    <h2 class="heading">Conforma xlsx to xlsx (Split) Dev</h2>        
    <div class="span11">
            <div class="alert alert-info">
                <strong>Conforma xlsx  > xlsx (Split) Dev</strong>
            </div>
        <form method="POST" class="form-horizontal" action="dev1_write.php" name="importexcel"  ENCTYPE="multipart/form-data" onsubmit="return checkfile();">
            ...
            <div class="control-group">    
                <label class="control-label">Conforma .XSLX to xlsx </label>
                <div class="controls">
            ...
            ?>
                <div class="alert alert-success">
                    <strong>Writer File successfully generated! <a href="dev1_write.php?action=download&file=<?=$_REQUEST['file']?>">Click here to download</a><strong>
                </div>
            <?  
            }   
